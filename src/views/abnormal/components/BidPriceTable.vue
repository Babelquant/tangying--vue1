<template>
  <div>
    ...
    >
      ...
      <el-table-column :label="$t('table.bid_price')" width="150px" align="left">
        <template slot-scope="{row}">
          <preview-chart :data="row.time_increase" />
        </template>
      </el-table-column>
...
<script>
  ...
  import PreviewChart from '@/views/dashboard/admin/components/PreviewChart'
